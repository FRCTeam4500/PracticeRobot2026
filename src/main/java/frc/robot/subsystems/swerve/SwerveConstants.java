...
public class SwerveConstants {
  ...
  public static final Translation2d FRONT_LEFT_TRANSLATION = new Translation2d(0.375, 0.375);

  /** The position of the front right module from the robot's center */
  public static final Translation2d FRONT_RIGHT_TRANSLATION = new Translation2d(0.375, -0.375);

  /** The position of the back left module from the robot's center */
  public static final Translation2d BACK_LEFT_TRANSLATION = new Translation2d(-0.375, 0.375);

  /** The position of the back right module from the robot's center */
  public static final Translation2d BACK_RIGHT_TRANSLATION = new Translation2d(-0.375, -0.375);

  /**
   * Config for the swerve modules...
   *
   * @param driveSupplyCurrentLimit The supply current limit for the drive motor.
   * @param driveSupplyCurrentLimitEnable Whether to enable supply current limiting on the drive
   *     motor
   * @param driveStatorCurrentLimit The stator current limit for the drive motor
   * @param driveStatorCurrentLimitEnable Whether to enable stator current limiting on the drive
   *     motor
   * @param driveConversionFactor Number that converts drive motor rotations to drive module meters
   *     traveled. Use the {@link Swerve#driveConversionFinder driveConversionFinder} command in
   *     Swerve.java to find these values!
   ...
   * @param angleGearReduction The gear ratio of the angle motor, either provided by cad team or the
   *     producer
   * @param angleAbsoluteEncoderOffset Reading of the absolute encoder when the module is faced
   *     forward (small gear on outside)
   * @param anglePID PID values for the drive motor
   * @param angleTolerance How close the module’s angle must be to the target to stop turning, in
   *     degrees)
  ...
  public static final ModuleConfig FRONT_LEFT_CONFIG =
      new ModuleConfig(
          ...
          FeedforwardController.forConstantGravity(0, 0.12619, 1.9287, 0.079077), // drive sysID
          20,
          25,
          0.415,
  ...
  public static final ModuleConfig FRONT_RIGHT_CONFIG =
      new ModuleConfig(
          ...
          FeedforwardController.forConstantGravity(0, 0.15084, 2.0679, 0.13208),
          20,
          25,
          0.588,
  ...
  public static final ModuleConfig BACK_LEFT_CONFIG =
      new ModuleConfig(
          ...
          20.11120785728702,
          new FeedbackConstants(0.1, 0, 0),
          FeedforwardController.forConstantGravity(0, 0.16252, 2.0607, 0.10109),
          20,
          25,
          0.830,
          new FeedbackConstants(0.075, 0, 0),
  ...
  public static final ModuleConfig BACK_RIGHT_CONFIG =
      new ModuleConfig(
          ...
          19.524774695067673,
          new FeedbackConstants(0.1, 0, 0), // drive PID
          FeedforwardController.forConstantGravity(0, 0.16696, 2.0434, 0.083132), // drive sysID
          20,
          25,
          0.594,
          new FeedbackConstants(0.075, 0, 0), // angle PID
